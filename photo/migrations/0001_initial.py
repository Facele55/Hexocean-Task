# Generated by Django 4.0.4 on 2022-05-30 13:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_size', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', easy_thumbnails.fields.ThumbnailerField(upload_to=photo.models.user_directory_path)),
        ...
        migrations.AddField(
            ...
            name='tier',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tier', to='photo.tier'),
        ),
        migrations.AddField(
            model_name='customuser',
